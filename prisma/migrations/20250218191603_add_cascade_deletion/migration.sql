...
-- DropForeignKey
ALTER TABLE "Oreder" DROP CONSTRAINT "Oreder_restaurantId_fkey";
...
-- AddForeignKey
ALTER TABLE "Oreder" ADD CONSTRAINT "Oreder_restaurantId_fkey" FOREIGN KEY ("restaurantId") REFERENCES "Restaurant"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "OrderProduct" ADD CONSTRAINT "OrderProduct_productId_fkey" FOREIGN KEY ("productId") REFERENCES "Product"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "OrderProduct" ADD CONSTRAINT "OrderProduct_orderId_fkey" FOREIGN KEY ("orderId") REFERENCES "Oreder"("id") ON DELETE CASCADE ON UPDATE CASCADE;
